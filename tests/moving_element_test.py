...
top_wall = Element(position=(0, 0), image_paths=["ball.png"], dimensions=(100, 20))
right_wall = Element(position=(80, 0), image_paths=["ball.png"], dimensions=(20, 100))
bottom_wall = Element(position=(0, 80), image_paths=["ball.png"], dimensions=(100, 20))
left_wall = Element(position=(0, 0), image_paths=["ball.png"], dimensions=(20, 100))

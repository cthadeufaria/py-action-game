...
class CheckCollisionMethod(TestCase):
    ...
    def test_overlapping_elements(self):
        ...
        e1 = Element(position=(100, 100), base_image_path="bat.png", dimensions=(50, 30))
        e2 = Element(position=(120, 120), base_image_path="ball.png", dimensions=(30, 10))
    ...
    def test_separated_elements(self):
        ...
        e1 = Element(position=(200, 100), base_image_path="bat.png", dimensions=(40, 20))
        e2 = Element(position=(100, 50), base_image_path="ball.png", dimensions=(40, 40))
